...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 7752098132307946427),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 3902422304227215417),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 1337071449502258471),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 3017210659061627020),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3902422304227215417),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 7752098132307946427),
